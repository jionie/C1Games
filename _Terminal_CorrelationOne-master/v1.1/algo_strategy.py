...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def create_collectors(self):
        ...
        # health since last attack
        self.my_health_since_last_attack = 30.
        self.enemy_health_since_last_attack = 30.

        # attack strategy
        # self.attack_direction = None  # left edge (0), right edge (1), default to None
        # self.attack_type = None  # PING (0), scrambler + EMP (1), default to None
    ...
    def attempt_attack(self, game_state, damages):
        ...
        low_defense_threshold = 20
        low_permeability_threshold = 4
        ...
        if self.my_health_since_last_attack - self.my_current_health >= my_health_damage_threshold:
        ...
        # update the health
        self.my_health_since_last_attack = self.my_current_health
